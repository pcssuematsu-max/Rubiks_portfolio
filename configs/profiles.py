    ...
    if size == 3:
        ...
        return (
            [
                ...
                (' L2', " U'", " B'", ' U2', ' R2', " D'", " F'", ' D ', ' R2', " U'", ' B ', ' L2', '3D2', '2D2', ' B2', ' L2', '3D2', '2D2', ' L2', ' B2', '3D2', '2D2', ' E ', ' F2', " E'", ' F2'),
                (' U ', ' L ', '2D2', '3D2', ' L2', ' F2', '2D2', '3D2', ' F2', ' L2', '2D2', '3D2', ' U ', " L'", ' U ', ' B2', " D'", ' R ', ' D ', ' B2', " R'", ' U ', " L'", " U'", ' R ', ' U ', ' L '),
                (' B ', ' D2', ' R2', ' U ', ' F ', " U'", ' R2', ' D ', " B'", ' D ', '3U2', '2U2', ' B2', ' L2', '3U2', '2U2', ' L2', ' B2', '3U2', '2U2', ' E ', ' F2', " E'", ' F2'),
                (" B'", ' D2', ' L2', " U'", " F'", ' U ', ' L2', " D'", ' B ', " D'", '2U2', '3U2', ' F2', ' R2', '3U2', '2U2', ' R2', ' F2', '3U2', '2U2', " E'", ' F2', ' E ', ' F2'),
                (' B2', ' L ', " U'", ' F2', ' D ', " R'", " D'", ' F2', ' U2', " L'", " U'", ' B2', '3U2', '2U2', ' L2', ' B2', '3U2', '2U2', ' B2', ' L2', '3U2', '2U2', " E'", ' B2', ' E ', ' B2'),
                (' L ', " U'", ' F2', ' D ', " R'", " D'", ' F2', ' U2', " L'", " U'", ' B2', '3U2', '2U2', ' L2', ' B2', '3U2', '2U2', ' B2', ' L2', '3U2', '2U2', " E'", ' B2', ' E '),
                (' B2', ' L ', " U'", ' F2', ' D ', " R'", " D'", ' F2', ' U2', " L'", " U'", ' B2', " E'", ' R2', ' E ', ' R2', '3D2', '2D2', ' L2', ' B2', '3D2', '2D2', ' B2', ' L2', '3D2', '2D2', " E'", ' F2', ' E ', ' F2'),
                (" R'", " D'", '2L2', '3L2', ' D2', ' F2', '2L2', '3L2', ' F2', ' D2', '2L2', '3L2', " R'", ' D ', " R'", ' B2', ' L ', " U'", " L'", ' B2', ' U ', " R'", ' D ', ' R ', " U'", " R'", " D'"),
                (" D'", " R'", " D'", '2L2', '3L2', ' D2', ' F2', '2L2', '3L2', ' F2', ' D2', '2L2', '3L2', " R'", ' D ', " R'", ' B2', ' L ', " U'", " L'", ' B2', ' U ', " R'", ' D ', ' R ', " U'", " R'"),
                ...
                (' R ', ' B ', " R'", ' F ', ' R ', " B'", " F'", " L'", ' F ', " R'", " F'", ' L '),
                (' L ', ' D ', " L'", ' U ', ' L ', " D'", " U'", " R'", ' U ', " L'", " U'", ' R '),
                (" R'", ' D2', ' R ', " U'", " R'", ' D2', " R'", ' U ', ' L2', " U'", ' R2', ' U ', ' L2'),
                ...
                ('2U2', " F'", "2R'", ' F ', ' R2', " F'", '2R ', " F'", "2U'", ' F2', '2U2', ' R2', '2U ', ' F2', '2U2', ' F2', ' R2', '2U ', ' R2'),
                ('2D2', ' B ', '2R ', " B'", ' R2', ' B ', "2R'", ' B ', '2D ', ' B2', '2D2', ' R2', '2U ', ' F2', '2D2', ' F2', ' R2', "2U'", ' R2'),
                ('2U2', ' B ', "2L'", " B'", ' R2', ' B ', '2L ', ' B ', "2U'", ' B2', '2U2', ' R2', "2D'", ' F2', '2U2', ' F2', ' R2', '2D ', ' R2'),
                ('2U2', ' F ', '2L2', " F'", ' R2', ' F ', '2L2', ' F ', "2U'", ' F2', '2U2', ' R2', '2U ', ' F2', '2U2', ' F2', ' R2', '2U ', ' R2'),
                ('2D2', ' F ', '2R2', " F'", ' R2', ' F ', '2R2', ' F ', '2D ', ' F2', '2D2', ' R2', "2D'", ' F2', '2D2', ' F2', ' R2', "2D'", ' R2'),
                ('2D2', ' L2', "2U'", ' R2', '2D ', ' R2', ' F2', '2D ', ' F2', "2D'", ' F2', '2U ', ' F2', ' L2', '2D2'),
                ("3D'", ' L2', '3U2', ' B2', "3U'", ' B2', "3U'", ' L2', '3D2', ' F2', "3D'", ' F2'),
                ('2D2', ' B2', "2U'", ' F2', "2D'", ' L2', '2U ', ' L2', ' F2', '2D ', ' R2', "2U'", ' R2', ' B2', '2D2'),
                ('2D2', ' B2', ' L2', "2D'", ' L2', '2U ', ' B2', "2U'", ' B2', '2D2', ' L2', '2D ', ' L2', "2D'", ' B2'),
                ("2U'", ' R2', '2D2', ' B2', "2D'", ' B2', '2D ', '2U ', ' R2', ' F2', '2D ', ' F2', ' R2', '2D2', ' R2'),
                ("2R "," U'","2F'"," U ","2R'"," U'","2F "," U "),
                ("2R "," U'","3F'"," U ","2R'"," U'","3F "," U "),
                ("2R "," U'"," S'"," U ","2R'"," U'"," S "," U "),
                ("2R "," U'","2F2"," U ","2R'"," U'","2F2"," U "),
                ("2R "," U'","3F2"," U ","2R'"," U'","3F2"," U "),
                ("2R "," U'"," S2"," U ","2R'"," U'"," S2"," U "),
                ("2R2"," U'","2F2"," U ","2R2"," U'","2F2"," U "),
                ("2R2"," U'","3F2"," U ","2R2"," U'","3F2"," U "),
                ("2R2"," U'"," S2"," U ","2R2"," U'"," S2"," U "),
                (" M "," U "," M2"," U2"," M2"," U "," M'"),
                (" S "," U "," S2"," U2"," S2"," U "," S'"),
                (" M'"," U "," M2"," U2"," M2"," U "," M "),
                (" S'"," U "," S2"," U2"," S2"," U "," S "),
